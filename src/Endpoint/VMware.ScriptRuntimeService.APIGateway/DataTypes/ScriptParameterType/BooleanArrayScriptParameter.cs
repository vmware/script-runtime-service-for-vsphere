...
namespace VMware.ScriptRuntimeService.APIGateway.DataTypes {
   /// <summary>
   /// BooleanArrayScriptParameter gives ability to provide argument of boolean array type to a script execution.
   /// </summary>
   [DataContract(Name = "boolean_array_script_parameter")]
   public class BooleanArrayScriptParameter : ScriptParameter {
      /// <summary>
