...
namespace VMware.ScriptRuntimeService.APIGateway.DataTypes {
   /// <summary>
   /// IntegerScriptParameter gives ability to provide argument of integer type to a script execution.
   /// </summary>
   [DataContract(Name = "integer_script_parameter")]
   public class IntegerScriptParameter : ScriptParameter {
      /// <summary>
