...
import io.swagger.client.model.PlaceholderValue;
 ...
 */
@Schema(description = "PlaceholderValueList object represents list of argument script placeholder values.")
...
public class PlaceholderValueList {
  ...
  private List<PlaceholderValue> values = new ArrayList<PlaceholderValue>();

  public PlaceholderValueList values(List<PlaceholderValue> values) {
    this.values = values;
    return this;
  }

  public PlaceholderValueList addValuesItem(PlaceholderValue valuesItem) {
   ...
   * @return values
  **/
  @Schema(required = true, description = "List of script placeholder values.")
  public List<PlaceholderValue> getValues() {
    return values;
  }

  public void setValues(List<PlaceholderValue> values) {
    this.values = values;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PlaceholderValueList placeholderValueList = (PlaceholderValueList) o;
    return Objects.equals(this.values, placeholderValueList.values);
  }
