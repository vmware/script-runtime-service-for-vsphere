 ...
 */
@JsonAdapter(OutputObjectsFormat.Adapter.class)
public enum OutputObjectsFormat {
  ...
  OutputObjectsFormat(String value) {
    this.value = value;
  }
  ...
  public static OutputObjectsFormat fromValue(String text) {
    for (OutputObjectsFormat b : OutputObjectsFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<OutputObjectsFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final OutputObjectsFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OutputObjectsFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OutputObjectsFormat.fromValue(String.valueOf(value));
    }
  }
}
