...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NumberScriptParameter :  IEquatable<NumberScriptParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberScriptParameter" /> class.
        /// </summary>
        ...
        public NumberScriptParameter(Object value = default(Object), string name = default(string), string script = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NumberScriptParameter and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberScriptParameter {\n");
        ...
        {
            return this.Equals(input as NumberScriptParameter);
        }

        /// <summary>
        /// Returns true if NumberScriptParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberScriptParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberScriptParameter input)
        {
            if (input == null)
                return false;
