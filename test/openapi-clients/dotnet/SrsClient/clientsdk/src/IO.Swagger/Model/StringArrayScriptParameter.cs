...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StringArrayScriptParameter :  IEquatable<StringArrayScriptParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringArrayScriptParameter" /> class.
        /// </summary>
        ...
        public StringArrayScriptParameter(Object value = default(Object), string name = default(string), string script = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for StringArrayScriptParameter and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringArrayScriptParameter {\n");
        ...
        {
            return this.Equals(input as StringArrayScriptParameter);
        }

        /// <summary>
        /// Returns true if StringArrayScriptParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of StringArrayScriptParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringArrayScriptParameter input)
        {
            if (input == null)
                return false;
