...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IntegerScriptParameter :  IEquatable<IntegerScriptParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerScriptParameter" /> class.
        /// </summary>
        ...
        public IntegerScriptParameter(Object value = default(Object), string name = default(string), string script = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for IntegerScriptParameter and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IntegerScriptParameter {\n");
        ...
        {
            return this.Equals(input as IntegerScriptParameter);
        }

        /// <summary>
        /// Returns true if IntegerScriptParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegerScriptParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegerScriptParameter input)
        {
            if (input == null)
                return false;
