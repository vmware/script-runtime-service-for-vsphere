...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IntegerArrayScriptParameter :  IEquatable<IntegerArrayScriptParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerArrayScriptParameter" /> class.
        /// </summary>
        ...
        public IntegerArrayScriptParameter(Object value = default(Object), string name = default(string), string script = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for IntegerArrayScriptParameter and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IntegerArrayScriptParameter {\n");
        ...
        {
            return this.Equals(input as IntegerArrayScriptParameter);
        }

        /// <summary>
        /// Returns true if IntegerArrayScriptParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegerArrayScriptParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegerArrayScriptParameter input)
        {
            if (input == null)
                return false;
