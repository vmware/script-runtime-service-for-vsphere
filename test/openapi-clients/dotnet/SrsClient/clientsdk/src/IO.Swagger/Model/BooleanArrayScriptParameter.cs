...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BooleanArrayScriptParameter :  IEquatable<BooleanArrayScriptParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanArrayScriptParameter" /> class.
        /// </summary>
        ...
        public BooleanArrayScriptParameter(Object value = default(Object), string name = default(string), string script = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for BooleanArrayScriptParameter and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BooleanArrayScriptParameter {\n");
        ...
        {
            return this.Equals(input as BooleanArrayScriptParameter);
        }

        /// <summary>
        /// Returns true if BooleanArrayScriptParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of BooleanArrayScriptParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BooleanArrayScriptParameter input)
        {
            if (input == null)
                return false;
