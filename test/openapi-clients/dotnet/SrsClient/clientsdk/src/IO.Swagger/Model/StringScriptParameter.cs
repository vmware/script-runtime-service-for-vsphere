...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StringScriptParameter :  IEquatable<StringScriptParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringScriptParameter" /> class.
        /// </summary>
        ...
        public StringScriptParameter(Object value = default(Object), string name = default(string), string script = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for StringScriptParameter and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as StringScriptParameter);
        }

        /// <summary>
        /// Returns true if StringScriptParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of StringScriptParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringScriptParameter input)
        {
            if (input == null)
                return false;
