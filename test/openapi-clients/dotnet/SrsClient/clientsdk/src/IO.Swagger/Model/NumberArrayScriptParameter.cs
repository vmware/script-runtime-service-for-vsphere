...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NumberArrayScriptParameter :  IEquatable<NumberArrayScriptParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberArrayScriptParameter" /> class.
        /// </summary>
        ...
        public NumberArrayScriptParameter(Object value = default(Object), string name = default(string), string script = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NumberArrayScriptParameter and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberArrayScriptParameter {\n");
        ...
        {
            return this.Equals(input as NumberArrayScriptParameter);
        }

        /// <summary>
        /// Returns true if NumberArrayScriptParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberArrayScriptParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberArrayScriptParameter input)
        {
            if (input == null)
                return false;
